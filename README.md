...
This table lists the configuration variables required to operate ReversingLabs TitaniumScale v2. These variables are specified when configuring a TitaniumScale asset in Splunk SOAR.
